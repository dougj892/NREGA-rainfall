I’ve included some notes on how the data in this archive is organized.
...
o	I haven’t included the stuff related to Indiramma payments (the last regression files in the rainfall paper)
o	I haven’t included all the do files I used to create the file “NREGA-mptc-census_panchayat_level_manually_created”.  This got really messy and there were a lot of manual steps involved.  
