/*
Purpose: Create cleaned NREGA_village_level file based on raw output from dataabase
Files Used: 3200, num_hhs_per_village_caste, num_worksites_per_village, and totals_by_village_caste_sex
...
* set paths
macro drop all
global input = "F:\NREGA\Data - reorganized\NREGA\Raw\Village level"
global output = "F:\NREGA\Data - reorganized\NREGA\Clean\Village level"
global extra = "F:\NREGA\Data - reorganized\Extra"


use "$input\totals_by_village_caste_sex.dta", clear
drop if distr == 0
...
compress
save "$output\NREGA_village_level.dta", replace
